...
# -*- coding: utf-8 -*-
'''
plot hydrograph for all the experiments
'''
...
#====================================================================
def plot_hydrograph(grdcid,station,experiments,rKGEs,syear=2016,eyear=2020):
    """
    ...
    legend=plt.legend(handles=features,loc="top left",bbox_transform=fig.transFigure, 
...
# os.system("mkdir -p ./pdffigure")
pdfname = "./pdffigure/hydrograph_all.pdf"
with PdfPages(pdfname) as pdf:
    for point in dfout.index:
        grdcid=dfout["GRDC_ID"][point]
        ...
        rKGEs=dfout.loc[point,labels]
        print (rKGEs)
        print (point,grdcid,station.strip()) #,expnum,expname, exp,rKGE)
        plot_hydrograph(grdcid,station,experiments,rKGEs,syear=syear,eyear=eyear)

...
! ************************************************
subroutine read_discharge_file(ndays, foutflw, nXX, nYY, dis)
! ===============================================
implicit none
! integer,intent(IN)                               :: sno
! integer,dimension(sno),intent(IN)                :: ix1,iy1
...
integer,intent(IN)                :: nXX, nYY
character*128,intent(IN)              :: foutflw
real,dimension(nXX,nYY,ndays),intent(OUT)   :: dis
...
open(12, file=foutflw, form='unformatted', access='direct', &
    & recl=4*ndays*nXX*nYY)
read(12,rec=1) dis
close(12)
end subroutine read_discharge_file
! ************************************************

...
# 
echo python src/map_best_rKGE.py $syear $eyear $CaMa_dir $mapname $EXLIST $STLIST $figname $NCPUS &
python src/map_best_rKGE.py $syear $eyear $CaMa_dir $mapname $EXLIST $STLIST $figname $NCPUS &

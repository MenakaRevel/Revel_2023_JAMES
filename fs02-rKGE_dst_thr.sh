...
figname="figs2-rKGE_boxplot_threshold"

#*** 0. experiment list
EXLIST="./Figs2-experiment_list.nam"
rm -r $EXLIST
cat >> ${EXLIST} << EOF
NOM_All_Dst_50KM: NOM_WSE_ERA5_CGLS_051
NOM_All_Dst_100KM: NOM_WSE_ERA5_CGLS_052
NOM_All_Dst_500KM: NOM_WSE_ERA5_CGLS_053
NOM_All_Dst_1000KM: NOM_WSE_ERA5_CGLS_054
EOF
